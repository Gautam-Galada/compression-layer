...
Usage:
    ...
    python scripts/train_local.py --model mlx-community/Qwen3-4B-Instruct-2507-4bit
...
Examples:
  ...
  python scripts/train_local.py --fuse --output models/fused/compression-v1
    ...
    parser.add_argument(
        ...
        help="Base model to fine-tune (default: mlx-community/Qwen3-4B-Instruct-2507-4bit)",
    )
